...
/**
 * This is the model class for table "daily_bo_kriteria_transaksi".
 *
 * The followings are the available columns in table 'daily_bo_kriteria_transaksi':
 * @property integer $jenis_transaksi_id
 * @property string $nama
 */
class dailyBoKriteriaTransaksi extends CActiveRecord
{
	/**
	...
	{
		return 'daily_bo_kriteria_transaksi';
	}
	 ...
	 * @return dailyBoKriteriaTransaksi the static model class
	 */
