 ...
 */
class DailysaController extends Controller{
    //put your code here
    ...
    public function actionIndex () {  
        $model=new dailySaKriteriaNasabah('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['dailySaKriteriaNasabah']))
			$model->attributes=$_GET['dailySaKriteriaNasabah'];
