    ...
    <br />
     ...
     // save for date
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $form->textField($model, "[$key]no_kontak", array('class'=>'span2', 'onClick'=>'checkForSelect(this);'));?>   
                <span class="help-inline error">
                <?php echo $form->error($model,"[$key]no_kontak"); ?>
                </span>
            </div>      
        </div>
        ...
        <div class="control-group">
            <?php echo $form->labelEx($model, "[$key]segmen",  array('class'=>'control-label'));?>
            <div class="controls">
                <?php echo $form->textField($model, "[$key]segmen", array('class'=>'span7'));?>                   
                <?php echo $form->error($model,"[$key]segmen"); ?>
            </div>             
        </div>            
        <div class="control-group">
