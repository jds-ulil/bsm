...
<fieldset>
    <legend>Input Data</legend>
        ...
        <?php echo $form->textFieldRow($model,'no_kontak',array('class'=>'span2','maxlength'=>50)); ?>
        <?php echo $form->textFieldRow($model,'total',array('class'=>'span2','maxlength'=>50, 'onClick'=>'checkForSelect(this);')); ?>
        <?php echo $form->textFieldRow($model,'segmen',array('class'=>'span5','maxlength'=>50)); ?>         
...
<?php
        $this->widget('application.extensions.moneymask.MMask',array(
            'element'=>'#dailySa_total, #dailySaArray_0_total',
            'currency'=>'PHP',
            'config'=>array(
                'symbolStay'=>true,
                'thousands'=>'.',
