...
insert  into `daily_cs`(`daily_cs_id`,`kriteria_nasabah`,`jumlah`,`total`,`nama_pegawai`,`info`,`tanggal`,`status`) values (1,2,12,22,'Ulil','Nice','0000-00-00',1),(2,3,56,120000,'Ulil','goode','0000-00-00',1),(4,1,12,111,'Raisa','','2015-02-05',2),(7,3,32,5000000,'Jacka','122','2015-02-23',2);
...
insert  into `daily_security`(`daily_security_id`,`nama_inputer`,`tanggal`,`jenis_nasabah`,`jumlah`,`info`,`status`) values (1,'Jono','2015-01-22',1,12,'Nice',2),(2,'hld','2015-02-02',1,3,'1',2),(3,'21','2015-01-22',5,14,'',2),(4,'aku','2015-02-04',1,13,'221',2);
