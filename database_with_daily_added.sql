...
insert  into `daily_cs`(`daily_cs_id`,`kriteria_nasabah`,`jumlah`,`total`,`nama_pegawai`,`info`,`tanggal`,`status`) values (1,1,3,45,'Customer Service1','Yuuu','2015-04-10',1),(2,17,15,45,'uu','2','2015-04-14',1),(3,1,5,45566,'uu','1','2015-04-14',1);
...
insert  into `daily_wm`(`daily_wm_id`,`jumlah_nasabah`,`kriteria_nasabah`,`no_kontak`,`total`,`nama_pegawai`,`info`,`status`,`tanggal`) values (1,4,15,'123',450000,'Ulil','',1,'2015-04-14'),(2,34,17,'885',122343,'Ulil','',1,'2015-04-14');
